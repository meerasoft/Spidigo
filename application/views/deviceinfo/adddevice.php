	...
	<div class="inner1">
		<div class="panel-body">
                        ...
                        <?php
							$this->load->helper('form');
							$attributes = array('class' => 'form-horizontal');
							echo form_open('Deviceinfo/adddevice',$attributes);
						?>
                    <fieldset>
	...
	<div class="inner2">
			<div class="panel-body">
						...
						<?php
							...
							echo form_open('Deviceinfo/adddevices',$attributes);
						?>
...
<input type="text" class="form-control dn'+ x +'" name="device['+ x + ']['+ "device_name" +']" value="'+ $(".dn"+y).val() +'" placeholder="DeviceName" required/><input type="text" class="form-control dn'+ x +'" name="device['+ x + ']['+ "device_name" +']" value="'+ $(".dn"+y).val() +'" placeholder="DeviceName" required/>